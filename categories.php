            ...
            <div class="card">
                <form action="?page=categories" method="POST">
                    <div class="card-header">
                        <p><i class="fa fa-pencil mr-2" aria-hidden="true"></i>Modifier la catégorie</p>
                    </div>
                    ...
                    <div class="form-group d-flex">
                        ...
                        <textarea name="category_desc" cols="30" rows="4" class="form-control" id="category_desc"></textarea>
                    </div>
                    <input type="submit" name="upload_category" class="btn btn-primary upload_category" value="Mise à jour">
